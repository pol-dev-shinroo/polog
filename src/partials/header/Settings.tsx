  ...
  return (
    <Box className="text-white flex-1 w-1/3 h-full">
      <Flex align="center" justify="center" className="h-full w-full">
        <Flex align="center" justify="end" className="w-1/3 h-full">
          <DarkModeToggle />
        </Flex>
        <Flex align="center" justify="center" className="w-2/3 h-full px-10">
          <Flex align="center" justify="center" className="w-1/2 h-full">
            <FramerBtn
